...
Dinosaur.prototype.roar = function() {
  if (this.name === "tyrannosaurus") return "RAWERSRARARWERSARARARRRR!";
};
...
for (let i = 0; i < graduates.length; i++) {
  // pull out university and push into universities array
...
const contactInfo = [];
// loop over the graduates array
for (let i = 0; i < graduates.length; i++) {
  // pull the first name and email of each student, push into new array
